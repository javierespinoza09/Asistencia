...
def sensor_velocidad(): # speed,count_wind_speed,wind_speed,ban,tiempoInicio_viento):
    ...
    global  condicion_precipitacion
    global  condicion_velocidad
...
def sensor_precipitacion(): # tiempoInicio,tiempoInicio_dia,tiempoInicio_Sensores,condicionSalida,condicionSalida_dia,bucket_size,count_hora,count_dia):
    ...
    global  condicion_velocidad
    condicion_precipitacion = False
    while ((time.monotonic() - condicionSalida_dia) < 51):
        ...
        elif time.monotonic() - condicionSalida >= 50:
            precipitacion_minuto = bucket_size*count_hora  # Precipitación por hora
            print("Ya pasaron, ", (time.monotonic() - condicionSalida) , "segundos, se va a dejar de contar")
            print("La cantidad de ticks que hubo fueron: ", count_hora)
            print("La precipitación por minuto fue de: ", precipitacion_minuto , "mm\n")
...
def sensores_varios():
    ...
    lectura_sensores= [bme280.temperature, bme280.relative_humidity,bme280.pressure, bme280.altitude, sensor.lux, WindDir(analog_in.value*3.3/65536)]
